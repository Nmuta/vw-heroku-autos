...
public class AutosControllerTests {
    ...
    void getAutos_searchParamColor_exists_returnsAutosList() throws Exception {
        ...
        when(autosService.getAutosByColorOrMake(anyString(), isNull())).thenReturn(new AutosList(automobiles));
    ...
    void getAutos_searchParamMake_exists_returnsAutosList() throws Exception {
        ...
        when(autosService.getAutosByColorOrMake(isNull(), anyString())).thenReturn(new AutosList(automobiles));
